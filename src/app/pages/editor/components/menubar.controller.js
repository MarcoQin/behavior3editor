(function() {
  ...
  function MenubarController($scope, 
    ...
    function _create() {
      ...
      Mousetrap.bind('command+q', _shortcut_projectclose);
      ...
      Mousetrap.bind('command+d', onDuplicate);
      Mousetrap.bind('del', onRemove);
      Mousetrap.bind('backspace', onRemove);
      Mousetrap.bind('a', onAutoOrganize);
      Mousetrap.bind('c', onToCenter);
      Mousetrap.bind('ctrl+a', onSelectAll);
      Mousetrap.bind('command+a', onSelectAll);
      Mousetrap.bind('ctrl+shift+a', onDeselectAll);
      Mousetrap.bind('command+shift+a', onDeselectAll);
      Mousetrap.bind('ctrl+i', onInvertSelection);
      Mousetrap.bind('command+i', onInvertSelection);
    }
    function _destroy() {
      Mousetrap.unbind('ctrl+q', _shortcut_projectclose);
      Mousetrap.unbind('command+q', _shortcut_projectclose);
      ...
      Mousetrap.unbind('command+d', onDuplicate);
      Mousetrap.unbind('del', onRemove);
      Mousetrap.unbind('backspace', onRemove);
      Mousetrap.unbind('a', onAutoOrganize);
      Mousetrap.unbind('c', onToCenter);
      Mousetrap.unbind('ctrl+a', onSelectAll);
      Mousetrap.unbind('command+a', onSelectAll);
      Mousetrap.unbind('ctrl+shift+a', onDeselectAll);
      Mousetrap.unbind('command+shift+a', onDeselectAll);
      Mousetrap.unbind('ctrl+i', onInvertSelection);
      Mousetrap.unbind('command+i', onInvertSelection);
    }
